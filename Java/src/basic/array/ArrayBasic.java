...
//		arr = 65; (x)
		...
		arr[1] = 88;
		arr[2] = arr[0];
//		arr[3] = 3.14; (x) 같은 타입만 가능-동종모음 구조
		arr[3] = (int) 3.14;
//		arr[4] = "들어갈까요?"; (x)
		arr[4] = 100;
//		arr[5] = 77; (x) index 범위를 초과.
		...
		//4. 배열의 총 크기(길이) 확인하는 법: 배열변수명.length
		System.out.println("arr 배열의 길이: " + arr.length);
		
		//5. 배열의 저장된 값 참조(사용)하는 법(인덱스를 이용)
		...
		//6. 배열의 반복문 처리
		//배열은 인데스 번호를 제어변수로 활용하여 쉽게 반복문을 처리할 수 있습니다.
		for(int idx=0; idx<arr.length; idx++) {
			System.out.printf("배열의 %d번째 데이터: %d\n", idx+1, arr[idx]);
		}

		//7. 배열 내부의 요소값을 문자열 형태로 한번에 출력하기.
