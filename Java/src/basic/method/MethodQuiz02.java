...
public class MethodQuiz02 {
	...
	//기존 배열보다 크기가 하나 더 큰 배열 선언해서 값 그대로 내리기
	//매개값으로 온 데이터를 마지막에 채우기
	...
	public static void main(String[] args) {
		...
		//파스타의 인덱스를 알아내세요.
		System.out.println("파스타 인덱스: " + indexOf("파스타"));

		//김치찌개 인덱스를 알아내세요.
		System.out.println("김치찌개 인덱스: " + indexOf("김치찌개"));

		//짜장면의 인덱스를 알아내세요. -> 만약 없는 음식이라면 -1을 리턴
		System.out.println("짜장면 인덱스: " + indexOf("짜장면"));
		...
		//라면의 존재 여부
		System.out.println("라면: " + include("라면"));
		
		//양념치킨의 존재 여부
		System.out.println("양념치킨: " + include("양념치킨"));
