...
//		int my birth day = 19930211;  (x)
		int mybirthday = 19930211;
		int myBirthDay = 19930211;  //camal case   _로 구분: snake case
...
//		String class = "클래스";  (x)
		...
		//7. class명은 항상 대문자로 시작, 식별자 이름은 항상 소문자로 시작
		//식별자 이름은 주로 명사, method는 주로 동사로 짓기(대충 짓지 말기)
