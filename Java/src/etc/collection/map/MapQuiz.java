...
public class MapQuiz {
	...
	public static void main(String[] args) {
        ...
        2. 사용자에게 영단어를 입력받아서, 이미 Map에 존재하는 단어라면 다시 입력받으세요. (이미 존재한다는 메세지 출력)
        ...
        */
		...
		System.out.println("*** 영단어장 만들기 ***");
		System.out.println("'그만'을 입력하면 입력이 종료됩니다.\n");
		...
		Set<String> words = engKor.keySet();
		for(String w : words) {
			System.out.println(w + ": " + engKor.get(w));
		}
