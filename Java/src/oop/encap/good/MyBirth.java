...
public class MyBirth {
	...
	/*
	 - 캡슐화(은닉)는 데이터에 접근 제한을 걸어서 정보롤 보호하는 것이 목적이지만 
	   private을 설정하면 데이터에 접근 자체가 불가능해짐.
	   
	 - 따라서 데이터의 유효성을 검증할 수 있는 제어문이 포함된 메서드를 사용하여 데이터의 접근을 허용하도록 설계하는데,
	 ...
	 3. 메서드 이름은 일반적으로 set + 멤버변수 이름으로 설정한다.
	 */
